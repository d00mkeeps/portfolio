...
date: 2026-06-26
minutes: 3
appStoreUrl: https://apps.apple.com/gb/app/clear-box/id6765638985
summary: A free, easy to use medicine tracker built on official NHS medicine data.
tags: [healthcare, ios, nhs, clear-box]
---

**Problem**

Three months ago, my cousin told me there were some issues with the app she'd been using to track her medicines. It was cumbersome to add new medicines, basic mechanisms in the app didn't work (time zone handling, for example) and it had started asking for a monthly subscription!
